...
export const ARCHON_STANDARD_COPY =
  "Every batch undergoes independent third-party analytical testing to verify identity and purity prior to release. Batch-specific Certificates of Analysis (COAs) are available through the Archon Quality & Verification Library, providing researchers with transparent documentation and confidence in every purchase.";
...
export const productContentBySlug: Record<string, ProductEditorialContent> = {
  ...
  glow: {
    lead:
      "Glow (TB-500 + BPC-157 + GHK-Cu) is a regenerative research blend designed to investigate complementary biological pathways. Each component of Glow (TB-500 + BPC-157 + GHK-Cu) has been independently studied for its role in cellular signaling and connective tissue biology.",
    overview:
      "The multi-peptide formulation of Glow (TB-500 + BPC-157 + GHK-Cu) gives researchers a streamlined approach to investigating regenerative processes within a single protocol.",
    scientificProfile: {
      classification: "Multi-Peptide Regenerative Research Blend",
      description:
        "Glow (TB-500 + BPC-157 + GHK-Cu) is a multi-peptide regenerative blend combining three well-characterized compounds. Glow (TB-500 + BPC-157 + GHK-Cu) supports investigation of connective tissue biology, extracellular matrix research, and cellular signaling.",
    },
    applications: [
    ...
    protocolSlugs: ["bpc-tb500", "nad-plus", "mots-c"],
    protocolIntro:
      "Glow (TB-500 + BPC-157 + GHK-Cu) is commonly incorporated into regenerative research protocols alongside Recover (BPC-157 + TB-500), Revive (NAD+), and Ascend (MOTS-c).",
  },
  "bpc-tb500": {
    lead:
      "Recover (BPC-157 + TB-500) is a regenerative peptide formulation developed to investigate connective tissue biology, structural integrity, and tissue remodeling. The balanced composition of Recover (BPC-157 + TB-500) supports research involving multiple biological pathways.",
    overview:
      "Recover (BPC-157 + TB-500) offers researchers a focused model for studying structural tissue response and regenerative processes.",
    scientificProfile: {
      classification: "Multi-Peptide Recovery Research Blend",
      description:
        "Recover (BPC-157 + TB-500) is a regenerative peptide blend developed to investigate connective tissue biology. Recover (BPC-157 + TB-500) supports studies involving tissue remodeling, extracellular matrix dynamics, and cellular signaling.",
    },
    applications: [
      "Connective tissue biology",
      "Tissue remodeling",
    ...
    protocolSlugs: ["glow", "nad-plus", "mots-c"],
    protocolIntro:
      "Recover (BPC-157 + TB-500) is commonly incorporated into regenerative research protocols alongside Glow (TB-500 + BPC-157 + GHK-Cu), Revive (NAD+), and Ascend (MOTS-c).",
  },
  "lemon-x": {
    lead:
  ...
  "nad-plus": {
    lead:
      "Revive (NAD+) contains nicotinamide adenine dinucleotide, a naturally occurring coenzyme central to cellular energy production and metabolic function. The role of Revive (NAD+) in mitochondrial biology has made it one of the most extensively studied molecules in cellular metabolism.",
    overview:
      "The biological importance of Revive (NAD+) has established it as a foundational compound in energy metabolism research.",
    scientificProfile: {
      classification: "Cellular Energy & Metabolic Research Compound",
      description:
        "Revive (NAD+) is a naturally occurring coenzyme involved in countless enzymatic reactions throughout the body. Revive (NAD+) supports investigation of mitochondrial biology, cellular metabolism, and physiological homeostasis.",
    },
    applications: [
    ...
    protocolSlugs: ["glow", "bpc-tb500", "mots-c"],
    protocolIntro:
      "Revive (NAD+) is commonly incorporated into research protocols alongside Glow (TB-500 + BPC-157 + GHK-Cu), Recover (BPC-157 + TB-500), and Ascend (MOTS-c).",
  },
  "mots-c": {
    lead:
